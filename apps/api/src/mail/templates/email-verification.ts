...
<body>
  <div class="card" role="article" aria-roledescription="email">
    ...
    <p class="lead">Ingresa el código único para finalizar la verificación de tu cuenta.</p>
    <p><span class="code">${otp}</span></p>
    <p class="info">El código vence en 10 minutos. Si no solicitaste la verificación, ignora este correo.</p>
