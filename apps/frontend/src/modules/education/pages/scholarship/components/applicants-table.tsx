...
import { useAcceptSelected } from '../pages/view-scholarship/hooks/use-accept-selected'
import { useGetApplicants } from '../pages/view-scholarship/hooks/use-get-applicant'
