import { useAcceptSelected } from '@frontend/modules/education/hooks/use-accept-selected'
import { useGetApplicants } from '@frontend/modules/education/hooks/use-get-applicant'
