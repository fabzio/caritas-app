import { useAcceptSelected } from '@frontend/modules/education/pages/scholarship/pages/create-scholarship/hooks/use-accept-selected'
import { useGetApplicants } from '@frontend/modules/education/pages/scholarship/pages/create-scholarship/hooks/use-get-applicant'
